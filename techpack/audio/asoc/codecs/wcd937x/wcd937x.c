...
static const char * const tx_master_ch_text_wcd937x[] = {
...
#ifdef OPLUS_ARCH_EXTENDS
const char * const die_crk_det_en_text_wcd937x[] = {"0x80", "0xC0"};
const u8 det_en_wcd937x[] = {0x80, 0xC0};

const char * const die_crk_det_int1_text_wcd937x[] = {"0xC2", "0x82", "0x42", "0x02"};
const u8 det_int1_wcd937x[] = {0xC2, 0x82, 0x42, 0x02};

const char * const die_crk_det_out_text_wcd937x[] = {"0x00"};

static SOC_ENUM_SINGLE_EXT_DECL(die_crk_det_en_enum, die_crk_det_en_text_wcd937x);
static SOC_ENUM_SINGLE_EXT_DECL(die_crk_det_int1_enum, die_crk_det_int1_text_wcd937x);
static SOC_ENUM_SINGLE_EXT_DECL(die_crk_det_out_enum, die_crk_det_out_text_wcd937x);
	...
	struct snd_ctl_elem_value *ucontrol)
{
	...
	if (ucontrol->value.enumerated.item[0] < ARRAY_SIZE(det_en_wcd937x)) {
		ctl_value = det_en_wcd937x[ucontrol->value.enumerated.item[0]];
	...
	struct snd_ctl_elem_value *ucontrol)
{
	...
	ucontrol->value.enumerated.item[0] = get_enum_index_from_reg(det_en_wcd937x, ARRAY_SIZE(det_en_wcd937x), reg);
	...
	struct snd_ctl_elem_value *ucontrol)
{
	...
	if (ucontrol->value.enumerated.item[0] < ARRAY_SIZE(det_int1_wcd937x)) {
		ctl_value = det_int1_wcd937x[ucontrol->value.enumerated.item[0]];
		ret = snd_soc_component_update_bits(component,
	...
	struct snd_ctl_elem_value *ucontrol)
{
	...
	ucontrol->value.enumerated.item[0] = get_enum_index_from_reg(det_int1_wcd937x, ARRAY_SIZE(det_int1_wcd937x), reg);
